...
public class FormTwo {
    private final SelenideElement userNameField = $("[name='val-username']").as("имя пользователя");
    ...
    private final SelenideElement emailField = $("[id='val-email']").as("email");
    ...
    private final SelenideElement passwordField = $("[id='val-password']").as("пароль");
    ...
    private final SelenideElement passwordConfirmField = $("[name='val-confirm-password']").as("повтор пароля");
    ...
    private final SelenideElement buttonSubmit = $("[id='valSubmitBtn']").as("кнопка отправки формы");
